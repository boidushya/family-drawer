...
const PrivateKeyView = () => {
  ...
  return (
    <div className="private-key__container">
      ...
      <h3 className="private-key--title">Private Key</h3>
      ...
      <div className="private-key--button--container">
        ...
        <button
          className="private-key--button private-key--button--reveal"
          onClick={() => setActiveView("default")}
        >
          <svg
            width="20"
  ...
  return (
    <div className="private-key__container">
      ...
      <div className="private-key--button--container">
        ...
        <button
          className="private-key--button private-key--button--remove"
          onClick={() => setActiveView("default")}
        >
          Continue
        </button>
...
const DefaultView = () => {
  ...
  return (
    <>
      <div className="tray__content--header">
        <h3 className="tray__content--title">Options</h3>
      </div>
      <div className="tray__content--button--container">
        <button
          className="tray__content--button"
          onClick={() => {
            setActiveView("private-key");
          }}
        >
          <svg
            width="20"
        ...
        <button
          className="tray__content--button tray__content--button--danger"
          onClick={() => {
            ...
            >
              ...
              >
                <motion.div ref={contentRef} className="tray__content">
                  <div className="tray__content--body">
                    <button
                      className="tray__content--close private-key--close"
                      onClick={() => setOpen(false)}
                    >
                      <svg
                        width="12"
